...
package com.example.mid_term_test_notepad;

import com.example.mid_term_test_notepad.NotePad;
...
public class NotesList extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        while (cursor.moveToNext()){
            Log.e(TAG,cursor.getString(cursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_TITLE)));
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        final Intent intent = new Intent(null, getIntent().getData());
